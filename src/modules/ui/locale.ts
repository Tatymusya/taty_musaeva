    ...
    if (metaDescription) {
      if (locale === 'en') {
        metaDescription.setAttribute(
          'content',
          'Full-Stack Developer Portfolio. Building modern web applications with React, Vue, Node.js'
        );
      } else {
        metaDescription.setAttribute(
          'content',
          'Портфолио Full-Stack разработчика. Создание современных веб-приложений на React, Vue, Node.js'
        );
      }
    }
